...
import GarnishChat from "@/components/GarnishChat";
...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-end px-6 md:px-16 pb-16 md:pb-20 pt-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            The Art of
            <br />
            <em className="not-italic text-gold">Private</em>
            <br />
            Bartending.
          </h1>
          ...
          <div className="anim-fade-up-2 flex flex-col md:flex-row md:items-end gap-8 md:gap-20">
            <p className="font-inter text-sm text-[var(--muted-light)] leading-[1.8] max-w-xs">
              Every glass is a composition. Every event, a performance.
              Nothing improvised — everything intentional.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="font-inter text-sm text-[var(--muted-light)] leading-[1.8] max-w-lg">
              Every event is different — here&apos;s a starting point. Reach
              out for a custom quote tailored to your guest count and occasion.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            <div className="group relative bg-[#141414] border border-white/8 p-8 md:hover:-translate-y-1 transition-transform duration-300">
              <p className="font-inter text-[9px] tracking-[0.3em] uppercase text-[var(--muted)] mb-6">
                Basic
              </p>

              <div className="mb-1">
                <span className="font-cormorant text-4xl font-semibold text-foreground">
                  Starting at $75
                </span>

                <span className="font-inter text-xs text-[var(--muted)] ml-1">
                  /hr
                </span>
              </div>
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-start gap-3 font-inter text-sm text-[var(--muted-light)] leading-[1.6]"
                  >
            ...
            <div className="group relative bg-[#141414] border border-gold/60 p-8 md:scale-[1.03] md:-translate-y-2 md:hover:-translate-y-3 transition-transform duration-300 shadow-[0_0_40px_rgba(201,168,76,0.08)]">
              <div className="flex items-center justify-between mb-6">
                <p className="font-inter text-[9px] tracking-[0.3em] uppercase text-[var(--muted)]">
                  Standard
                </p>

                <span className="font-inter text-[8px] tracking-[0.2em] uppercase text-[#0a0a0a] bg-gold px-2.5 py-1">
                  Most Popular
                </span>
              </div>
          ...
          <div className="mt-14 pt-10 border-t border-white/6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <p className="font-inter text-xs text-[var(--muted)] leading-[1.8] max-w-xl">
              Final pricing depends on guest count, event length, location, and
              specific requests. Fill out the contact form or call directly for
              an accurate quote.
            </p>
      ...
      <section
        id="process"
        className="py-28 px-6 md:px-16 bg-[#0d0d0d] border-t border-white/6"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/6">
            {[
              ...
              <div
                key={step.n}
                className="py-10 md:py-0 md:px-12 first:md:pl-0 last:md:pr-0 group"
              >
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-10 mb-14">
            <div>
              ...
              <p className="font-inter text-xs text-[var(--muted)] leading-[1.8] max-w-[220px]">
                Bespoke cocktail service for private events — crafted with
                care, served with intention.
              </p>
